import{a as $,h as R,i as j,p as z,r as N}from"./api-IMK_rRYA.js";const Z="modulepreload",G=function(t){return"/"+t},D={},Q=function(e,n,a){let o=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),s=(r==null?void 0:r.nonce)||(r==null?void 0:r.getAttribute("nonce"));o=Promise.allSettled(n.map(l=>{if(l=G(l),l in D)return;D[l]=!0;const i=l.endsWith(".css"),f=i?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${f}`))return;const m=document.createElement("link");if(m.rel=i?"stylesheet":Z,i||(m.as="script"),m.crossOrigin="",m.href=l,s&&m.setAttribute("nonce",s),document.head.appendChild(m),i)return new Promise((T,y)=>{m.addEventListener("load",T),m.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${l}`)))})}))}function c(r){const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=r,window.dispatchEvent(s),!s.defaultPrevented)throw r}return o.then(r=>{for(const s of r||[])s.status==="rejected"&&c(s.reason);return e().catch(c)})},ee="1.3",p="automationWindowId";async function L(t){try{return await chrome.windows.get(t),!0}catch{return!1}}async function O(){const e=(await chrome.storage.local.get(p))[p];if(e!==void 0&&await L(e))return e;e!==void 0&&await chrome.windows.remove(e).catch(()=>{});const n=await chrome.windows.create({focused:!1,state:"minimized"});if(!(n!=null&&n.id))throw new Error("automation_window_create_failed");return await chrome.storage.local.set({[p]:n.id}),n.id}async function C(t){const e=await O(),n=await chrome.tabs.create({windowId:e,url:t,active:!0});if(!n.id)throw new Error("tab_create_failed");return await chrome.windows.update(e,{focused:!1,state:"minimized"}).catch(()=>{}),n.id}async function U(){const e=(await chrome.storage.local.get(p))[p];e!==void 0&&!await L(e)&&await chrome.storage.local.remove(p)}async function x(t){await new Promise((e,n)=>{chrome.debugger.attach({tabId:t},ee,()=>{chrome.runtime.lastError?n(new Error(chrome.runtime.lastError.message)):e()})})}async function _(t){await new Promise(e=>{chrome.debugger.detach({tabId:t},()=>{chrome.runtime.lastError,e()})})}async function u(t,e,n={}){return await new Promise((a,o)=>{chrome.debugger.sendCommand({tabId:t},e,n,c=>{chrome.runtime.lastError?o(new Error(chrome.runtime.lastError.message)):a(c)})})}async function g(t,e,n){await u(t,"Input.dispatchMouseEvent",{type:"mouseMoved",x:e,y:n,button:"none",buttons:0}),await b(50),await u(t,"Input.dispatchMouseEvent",{type:"mousePressed",x:e,y:n,button:"left",buttons:1,clickCount:1}),await b(50),await u(t,"Input.dispatchMouseEvent",{type:"mouseReleased",x:e,y:n,button:"left",buttons:0,clickCount:1})}async function te(t,e){await u(t,"Input.insertText",{text:e})}async function ne(t,e,n){await u(t,"Input.dispatchKeyEvent",{type:"keyDown",key:e,code:e,windowsVirtualKeyCode:n,nativeVirtualKeyCode:n}),await b(30),await u(t,"Input.dispatchKeyEvent",{type:"keyUp",key:e,code:e,windowsVirtualKeyCode:n,nativeVirtualKeyCode:n})}async function oe(t){var n;const e=await u(t,"Runtime.evaluate",{expression:`(function() {
      ...
      return null;
    })()`,returnByValue:!0});return((n=e==null?void 0:e.result)==null?void 0:n.value)??null}async function re(t){var n;const e=await u(t,"Runtime.evaluate",{expression:`(function() {
      const compose =
      ...
      return false;
    })()`,returnByValue:!0});return((n=e==null?void 0:e.result)==null?void 0:n.value)===!0}async function K(t){var n;const e=await u(t,"Runtime.evaluate",{expression:`(function() {
      const el = document.querySelector('a[href*="/messaging/compose/"]');
      if (!el) return null;
      const r = el.getBoundingClientRect();
      if (r.width === 0 && r.height === 0) return null;
      return el.href || null;
    })()`,returnByValue:!0});return((n=e==null?void 0:e.result)==null?void 0:n.value)??null}async function W(t,e){var a;const n=await u(t,"Runtime.evaluate",{expression:`(function() {
      ...
      el.click();
      return true;
    })()`,returnByValue:!0});return(a=n==null?void 0:n.result)!=null&&a.value?(await u(t,"Input.insertText",{text:e}),!0):!1}async function F(t){var n;const e=await u(t,"Runtime.evaluate",{expression:`(function() {
      const countDeep = (sel) => {
        let n = 0;
        const walk = (root) => {
      ...
      return findSend(document);
    })()`,returnByValue:!0});return((n=e==null?void 0:e.result)==null?void 0:n.value)===!0}async function ie(t){var n;const e=await u(t,"Runtime.evaluate",{expression:`(function() {
        const selectors = [
        ...
        return null;
      })()`,returnByValue:!0});return((n=e==null?void 0:e.result)==null?void 0:n.value)??null}async function w(t){var n;const e=await u(t,"Runtime.evaluate",{expression:`[...document.querySelectorAll('button,[role="button"]')].map(b=>{const r=b.getBoundingClientRect();return{cls:b.className.slice(0,80),aria:b.getAttribute('aria-label')||'',text:b.textContent?.trim().slice(0,30)||'',x:Math.round(r.left),y:Math.round(r.top),w:Math.round(r.width),h:Math.round(r.height)}}).filter(b=>b.w>0&&b.h>0&&b.y<800)`,returnByValue:!0});return((n=e==null?void 0:e.result)==null?void 0:n.value)??[]}async function H(t){const e=await w(t);for(const o of e)if(/^(dismiss|close|cancel)$/i.test(o.aria)||/artdeco-modal__dismiss/i.test(o.cls)||/dismiss/i.test(o.cls)||o.text==="×"||o.text==="✕"||o.text==="✖")return await g(t,o.x+Math.round(o.w/2),o.y+Math.round(o.h/2)),!0;const n=await le(t),a=e.find(o=>o.w<50&&o.h<50&&o.y<300&&o.x>n*.4);return a?(await g(t,a.x+Math.round(a.w/2),a.y+Math.round(a.h/2)),!0):!1}async function le(t){var n;const e=await u(t,"Runtime.evaluate",{expression:"window.innerWidth",returnByValue:!0});return((n=e==null?void 0:e.result)==null?void 0:n.value)??1440}async function ce(t,e){var a;const n=await u(t,"Runtime.evaluate",{expression:`(function(txt) {
    ...
    })(${JSON.stringify(e)})`,returnByValue:!0});return((a=n==null?void 0:n.result)==null?void 0:a.value)===!0}async function J(t,e){var c;const n=await u(t,"Runtime.evaluate",{expression:"({ w: window.innerWidth, h: window.innerHeight })",returnByValue:!0}),{w:a,h:o}=((c=n==null?void 0:n.result)==null?void 0:c.value)??{w:1440,h:900};await u(t,"Input.dispatchMouseEvent",{type:"mouseWheel",x:Math.round(a/2),y:Math.round(o/2),deltaX:0,deltaY:e})}async function X(t){for(let e=0;e<5;e++)await u(t,"Input.dispatchKeyEvent",{type:"keyDown",key:"Escape",code:"Escape",windowsVirtualKeyCode:27,nativeVirtualKeyCode:27}),await b(50),await u(t,"Input.dispatchKeyEvent",{type:"keyUp",key:"Escape",code:"Escape",windowsVirtualKeyCode:27,nativeVirtualKeyCode:27}),await b(150)}async function se(t,e,n){var o;const a=await u(t,"Runtime.evaluate",{expression:`(function(txt, name) {
    ...
    })(${JSON.stringify(e)}, ${JSON.stringify(n)})`,returnByValue:!0});return((o=a==null?void 0:a.result)==null?void 0:o.value)===!0}async function M(t){return(await u(t,"Page.captureScreenshot",{format:"png",quality:80})).data}function b(t){return new Promise(e=>setTimeout(e,t))}const ue=Object.freeze(Object.defineProperty({__proto__:null,attach:x,click:g,clickModalClose:H,clickSendButton:Y,closeAllComposeOverlays:X,closeStaleAutomationWindow:U,composeDiag:F,detach:_,evalFindCompose:ie,findMessageButton:oe,focusCompose:ae,getAutomationWindow:O,getComposeCoords:re,getComposeUrl:K,insertTextIntoCompose:ce,insertTextIntoNamedCompose:se,openTabInAutomationWindow:C,pressKey:ne,scanButtons:w,scrollBy:J,send:u,takeScreenshot:M,typeIntoCompose:W,typeText:te},Symbol.toStringTag,{value:"Module"})),de=`(() => {
  const all = [];
  const walk = (root) => {
  ...
  return 'connectable';
})()`,fe=30,he=60,A="0.2.0";let k=!1;async function B(t){await chrome.storage.local.set({swActiveTabId:t})}async function E(){await chrome.storage.local.remove("swActiveTabId")}(async()=>{try{await U().catch(()=>{});const{swActiveTabId:t}=await chrome.storage.local.get("swActiveTabId");t&&(console.log("[startup] closing orphaned tab",t),await chrome.tabs.remove(t).catch(()=>{}),await E())}catch(t){console.warn("[startup] cleanup error",t)}})();chrome.runtime.onInstalled.addListener(()=>{chrome.alarms.create("poll",{periodInMinutes:fe/60}),chrome.alarms.create("hb",{periodInMinutes:he/60})});$().then(t=>{t&&R(A)});chrome.runtime.onMessage.addListener(t=>{(t==null?void 0:t.type)==="heartbeat"&&R(A)});chrome.alarms.onAlarm.addListener(async t=>{if(await $()&&!await j()){if(t.name==="hb"){await R(A);return}if(t.name==="poll"){if(k){console.log("[poll] task already running, skipping");return}for(;await me(););}}});async function me(){let t;try{t=await z()}catch(e){return console.warn("poll error",e),!1}if(!t)return!1;k=!0;try{const e=await we(t);await N(t.id,{ok:!0,result:e})}catch(e){const n=e.code??"unknown",a=e.screenshot,o=e.buttons;await N(t.id,{ok:!1,errorCode:n,errorMessage:e.message,...a||o?{result:{debugScreenshot:a,buttons:o}}:{}})}finally{k=!1}return!0}async function we(t){const e=t.payload;if(t.kind==="SEND"){if(!e.linkedinUrl||!e.text)throw d(new Error("missing_payload"),"bad_payload");return await pe(e.linkedinUrl,e.text,e.recipientName??"")}if(t.kind==="CHECK_REPLY")return{replyDetected:!1,replies:[]};if(t.kind==="SEARCH"){if(!e.searchUrl)throw d(new Error("missing_payload"),"bad_payload");return await ye(e.searchUrl)}if(t.kind==="CONNECT"){if(!e.profileUrl)throw d(new Error("missing_payload"),"bad_payload");return await ve(e.profileUrl)}throw d(new Error("unknown_kind"),"bad_payload")}async function pe(t,e,n=""){var s;const a=await chrome.tabs.create({url:t,active:!0});if(!a.id)throw d(new Error("tab_create_failed"),"tab_load");const o=a.id;await B(o);let c=!1,r=null;try{await v(o),await h(2500);const l=await chrome.tabs.get(o);l.windowId&&await chrome.windows.update(l.windowId,{focused:!0}),await h(300);const i=await chrome.tabs.get(o);if(i.url&&i.url.includes("/checkpoint"))throw d(new Error("checkpoint"),"checkpoint");await x(o),c=!0;const f=await(await Q(async()=>{const{send:S}=await Promise.resolve().then(()=>ue);return{send:S}},void 0)).send(o,"Runtime.evaluate",{expression:"window.devicePixelRatio",returnByValue:!0}),m=((s=f==null?void 0:f.result)==null?void 0:s.value)??1;console.log("[agent] devicePixelRatio:",m),await chrome.scripting.executeScript({target:{tabId:o},func:S=>navigator.clipboard.writeText(S),args:[e]}),await h(200),await X(o),await h(500),await H(o)&&(console.log("[agent] dismissed popup before Message click"),await h(500));const y=await K(o);if(!y)throw d(new Error("message_button_not_found"),"not_messageable");console.log("[agent] composeUrl:",y),await chrome.tabs.update(o,{url:y}),await v(o),await h(2500);const q=await F(o);console.log("[agent] post-nav diag:",q);const I=await W(o,e);if(console.log("[agent] typeIntoCompose:",I),!I)throw d(new Error(`compose_insert_failed diag=${JSON.stringify(q)}`),"compose_insert_failed");await h(600);const P=await Y(o);if(console.log("[agent] clickSendButton:",P),!P)throw d(new Error("send_button_not_found"),"send_button_not_found");return await h(1500),{sentAt:new Date().toISOString(),conversationUrl:t,steps:3}}catch(l){r=l;const i=await chrome.tabs.get(o).catch(()=>null);if(i!=null&&i.url&&(r.message=`${r.message} (url=${i.url})`),c)try{const[f,m]=await Promise.all([M(o),w(o)]);r.screenshot=f,r.buttons=m}catch{}throw r}finally{c&&await _(o).catch(()=>{}),await chrome.tabs.remove(o).catch(()=>{}),await E()}}const ge=`(() => {
  ...
  return { candidates: out, hasNextPage };
})()`;async function ye(t){var a;const e=await C(t).catch(()=>{throw d(new Error("tab_create_failed"),"tab_load")});await B(e);let n=!1;try{await v(e),await h(2500);const o=await chrome.tabs.get(e);if(o.url&&o.url.includes("/checkpoint"))throw d(new Error("checkpoint"),"checkpoint");await x(e),n=!0;for(let s=0;s<6;s++)await J(e,1200),await h(800);const c=await u(e,"Runtime.evaluate",{expression:ge,returnByValue:!0}),r=(a=c==null?void 0:c.result)==null?void 0:a.value;if(!r)throw d(new Error("scrape_returned_null"),"scrape_failed");return r}finally{n&&await _(e).catch(()=>{}),await chrome.tabs.remove(e).catch(()=>{}),await E()}}async function V(t,e){var a;const n=await u(t,"Runtime.evaluate",{expression:`(() => {
      ...
      return fallback;
    })()`,returnByValue:!0});return((a=n==null?void 0:n.result)==null?void 0:a.value)??null}async function be(t){var n;const e=await u(t,"Runtime.evaluate",{expression:`(() => {
      let dlg = null;
      const findDlg = (root) => {
        if (dlg) return;
