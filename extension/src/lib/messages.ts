...
export interface PageResults {
  ...
  READ_PROFILE_FULL: {
    ...
    revealed: { scrolls: number; found: boolean; experience: boolean; education: boolean; skills: boolean; about: boolean; viewport: { w: number; h: number }; page: { sections: number; headings: string[]; scrollVia: string; docHeight: number; hidden: boolean }; samples: Record<string, { found: boolean; lis: number; childTags: string[]; html: string }> };
  };
