...
export async function pollTask(): Promise<null | { id: string; kind: "SEND" | "CHECK_REPLY" | "SEARCH" | "CONNECT" | "RESOLVE_COMPANY" | "SCRAPE_PROFILE" | "PREPARE_MESSAGE" | "SCRAPE_POSTS" | "PREPARE_COMMENT"; payload: unknown }> {
