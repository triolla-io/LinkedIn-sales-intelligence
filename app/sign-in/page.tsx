    ...
    <main className="flex min-h-screen items-center justify-center bg-[#f6f5f3]">
      <div className="flex flex-col items-center gap-6 rounded-xl border border-[#e5e3df] bg-white p-10 shadow-sm w-full max-w-sm">
        ...
        <a
          ...
          className="flex items-center justify-center gap-2.5 w-full rounded-lg border border-[#e5e3df] bg-white hover:bg-[#f8f7f5] hover:border-[#1585ff]/30 px-5 py-2.5 text-sm font-medium text-[#111110] transition-all no-underline"
        >
